...
public class Introspector
{
	...
	private PropertyDescriptor mergePropertyDescriptor(IndexedPropertyDescriptor ipd, PropertyDescriptor pd)
	{
		...
		} else
		{
			...
			} else
			{
				...
				{
					write = findMethod(result.getClass0(), "set" + result.capitalize(result.getName()), 1,
	...
	/*
	 * Internal method to returnpublic methods within a class.
	 */
	 ...
	 * <p>
	 * Used in the contructors of the EventSetDescriptor, PropertyDescriptor and
	 * the IndexedPropertyDescriptor.
	 * <p>
	 * 
	 * @param cls
	 *            The Class object on which to retrieve the method.
	 * @param methodName
	 *            Name of the method.
	 * @param argCount
	 *            Number of arguments for the desired method.
	 * @param args
	 *            Array of argument types for the method.
	 ...
	 * current Thread.
	 */
	static Object instantiate(Class sibling, String className) throws InstantiationException, IllegalAccessException,
