 ...
 * @since 0.8.4
 */
public class XDSocketNode implements Runnable
{
	Socket socket;
	...
	public XDSocketNode(Socket socket, LoggerRepository hierarchy)
	{
		this.socket = socket;
	...
	public void run()
	{
		...
		try
		{
			while (true)
			{
				LoggingData data = ((LoggingData) ois.readObject());
				...
				{
					//System.out.println("--------remoteLog:projectName:" + data.projectName);
