...
public class XDSocketAppender extends AppenderSkeleton
{

	/***
	 * The default port number of remote logging server (4567).
	 */
	 ...
	 */
	public XDSocketAppender(InetAddress address, int port)
	{
	 ...
	 */
	public XDSocketAppender(String host, int port)
	{
		this.port = port;
	...
	public void append(LoggingEvent event)
	{
		...
		if (oos != null)
		{
			try
			{
				...
				oos.writeObject(new LoggingData(projectName, event));
