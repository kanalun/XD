...
public class Logger extends Category
{
	...
	/**
	 * Log a message object with the {@link Level#FINE FINE} level which is just
	 * an alias for the {@link Level#DEBUG DEBUG} level.
	 * 
	 * <p>
	 ...
	 * returns string value: "root". However, calling
	 * <code>Logger.getLogger("root")</code> does not retrieve the root logger
	 ...
	 *            The name of the logger to retrieve.
	 * @param factory
	 *            A {@link LoggerFactory} implementation that will actually
