...
public class Hierarchy implements LoggerRepository, RendererSupport, ThrowableRendererSupport
{
	 ...
	 * 
	 * @param l
	 *            The minimum level for which logging requests are sent to their
	 *            appenders.
	 */
	 ...
	 * Otherwise, a new logger will be instantiated and then linked with its
	 ...
	 * <p>
	 * If a logger of that name already exists, then it will be returned.
	 * Otherwise, a new logger will be instantiated by the <code>factory</code>
	...
	/**
	 * This method will return <code>true</code> if this repository is disabled
	 * for <code>level</code> object passed as parameter and <code>false</code>
	 ...
	 * This removes all appenders from all categories, sets the level of all
	 * non-root categories to <code>null</code>, sets their additivity flag to
	 * <code>true</code> and sets the level of the root logger to
	 * {@link Level#DEBUG DEBUG}. Moreover, message disabling is set its default
	 * "off" value.
	 * 
	 * <p>
	...
	/**
	 * Shutting down a hierarchy will <em>safely</em> close and remove all
	 ...
	 * regular appender is attached to a logger and again to a nested appender.
	 * 
	 * @since 1.0
	 */
