...
final public class RootCategory extends Logger
{
	...
	/**
	 * The root category names itself as "root". However, the root category
	 ...
	 */
	final public Level getChainedLevel()
	{
		return level;
	}

	/**
	 * Setting a null value to the level of the root category may have
	 * catastrophic results. We prevent this here.
	 * 
	 * @since 0.8.3
	 */
	final public void setLevel(Level level)
	{
		if (level == null)
		{
	...
	final public void setPriority(Level level)
	{
		setLevel(level);
	}
