 ...
 * <code>Loggers</code>. The relation between loggers in a repository depends on
 * the repository but typically loggers are arranged in a named hierarchy.
 * 
 * <p>
 * In addition to the creational methods, a <code>LoggerRepository</code> can be
 * queried for existing loggers, can act as a point of registry for events
 * related to loggers.
 * 
