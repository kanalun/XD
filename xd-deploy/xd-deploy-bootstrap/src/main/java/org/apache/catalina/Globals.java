...
public final class Globals
{
	 ...
	 * application class loader (as an object of type String), delimited with
	 * the appropriate path delimiter for this platform.
	 */
	...
	/**
	 * The request attribute under which we store the session id being used for
	...
	/**
	 * The servlet context attribute under which we store a flag used to mark
	 * this request as having been processed by the SSIServlet. We do this
	 * because of the pathInfo mangling happening when using the CGIServlet in
	 * conjunction with the SSI servlet. (value stored as an object of type
	 * String)
	 */
	 ...
	 * path
	 */
	public static final String APP_LOADER_HOME_PROP = "catalina.home";
