...
public final class Tool
{
	 ...
	 */
	private static String catalinaHome = System.getProperty(Globals.APP_LOADER_HOME_PROP);
	...
	public static void main(String args[])
	{
		...
		if (debug)
		{
			catalinaHome = "E:/Program Files/Apache Tomcat 7";
		}
		// Verify that "catalina.home" was passed.
		if (catalinaHome == null)
		{
			log.error("Must set '" + Globals.APP_LOADER_HOME_PROP + "' system property");
			System.exit(1);
		}
