...
public final class Bootstrap
{
	...
	private ClassLoader createClassLoader(String name, ClassLoader parent) throws Exception
	{
		...
		// Retrieving MBean server REMOVED
		return classLoader;
	...
	protected String replace(String str)
	{
		...
		if (pos_start >= 0)
		{
			...
			while (pos_start >= 0)
			{
				...
				{
					replacement = null;
				} else if (Globals.APP_LOADER_HOME_PROP.equals(propName))
				{
	...
	{
		System.setProperty(Globals.APP_LOADER_HOME_PROP, s);
	}
	...
	private void setCatalinaHome()
	{
		...
		if (bootstrapJar.exists())
		{
			...
			{
				// Ignore
				System.setProperty(Globals.APP_LOADER_HOME_PROP, System.getProperty("user.dir"));
			}
		} else
		{
			System.setProperty(Globals.APP_LOADER_HOME_PROP, System.getProperty("user.dir"));
	...
	{
		return System.getProperty(Globals.APP_LOADER_HOME_PROP, System.getProperty("user.dir"));
	}
