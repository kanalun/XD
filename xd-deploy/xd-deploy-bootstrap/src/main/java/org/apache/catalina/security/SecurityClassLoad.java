...
public final class SecurityClassLoad
{
	...
	private static final void loadCorePackage(ClassLoader loader) throws Exception
	{
		...
		loader.loadClass(basePackage + "AsyncContextImpl$PrivilegedGetTccl");
		loader.loadClass(basePackage + "AsyncContextImpl$PrivilegedSetTccl");
	...
	private static final void loadTomcatPackage(ClassLoader loader) throws Exception
	{
		...
		loader.loadClass(basePackage + "util.net.AprEndpoint$PrivilegedSetTccl");
	}
}
