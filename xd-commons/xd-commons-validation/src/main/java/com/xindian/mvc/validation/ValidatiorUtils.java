...
import com.xindian.mvc.validation.Tools.Email;
import com.xindian.mvc.validation.Tools.ISBN;
import com.xindian.mvc.validation.Validation.FixedLength;
import com.xindian.mvc.validation.Validation.MaxLength;
import com.xindian.mvc.validation.Validation.MinLength;
import com.xindian.mvc.validation.Validation.NotEmpty;
import com.xindian.mvc.validation.Validation.NotNull;
import com.xindian.mvc.validation.Validation.OperatorType;
import com.xindian.mvc.validation.Validation.RegexValidator;
import com.xindian.mvc.validation.Validation.Required;
import com.xindian.mvc.validation.validators.FixedLengthValidator;
import com.xindian.mvc.validation.validators.MaxLengthValidator;
import com.xindian.mvc.validation.validators.MinLengthValidator;
import com.xindian.mvc.validation.validators.NotEmptyValidator;
import com.xindian.mvc.validation.validators.NotNullValidator;
...
public class ValidatiorUtils
{
	...
	public static boolean validate(Object bean)// 验证bean是否符合注解
	{
		try
		{
			...
			ValidatorFactory.addValidator(RegexValidator.class, new com.xindian.mvc.validation.validators.RegexValidator());
