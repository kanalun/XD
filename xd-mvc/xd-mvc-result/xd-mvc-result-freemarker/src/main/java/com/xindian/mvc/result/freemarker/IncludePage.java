...
public class IncludePage implements TemplateDirectiveModel
{
			...
			throws TemplateException, IOException
	{
		...
		{
			throw new TemplateException("Expected a scalar model. 'path' is instead " + path.getClass().getName(), env);
		}
		...
		} else
		{
			...
			if (paramsModel != null)
			{
				...
				{
					throw new TemplateException("Expected 'params' to unwrap " + "into a java.util.Map. It unwrapped into "
