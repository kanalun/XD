...
public class JMXClient
{
	...
	public static JMXClient getJMXClient(String hostName, int port, String userName, String password) throws JMXClientException
	{
	...
	private JMXClient(String hostName, int port, String userName, String password) throws JMXClientException
	{
		...
		try
		{
			this.address = new JMXServiceURL("service:jmx:rmi:///jndi/rmi://" + this.hostName + ":" + this.port + "/jmxrmi");
	...
	public Object invoke(ObjectName name, String operationName, Object[] params, String[] signature) throws JMXClientException
	{
		tryReconnect();
		try
		{
