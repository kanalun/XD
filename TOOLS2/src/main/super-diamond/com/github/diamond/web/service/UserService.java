...
public class UserService
{
	...
	public Object login(String userCode, String password)
	{
		...
		try
		{
			String sql = "SELECT ID, USER_NAME, PASSWORD, DELETE_FLAG " + "FROM CONF_USER WHERE USER_CODE = ?";
	...
	{
		String sql = "SELECT ID, USER_CODE, USER_NAME " + "FROM CONF_USER WHERE DELETE_FLAG = 0";
	...
	public void saveUser(User user)
	{
		...
		sql = "insert into CONF_USER (ID, USER_CODE, USER_NAME, PASSWORD, CREATE_TIME) " + "values (?, ?, ?, ?, ?)";
