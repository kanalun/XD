...
public final class PropertyConverter
{
	...
	static Object to(Class<?> cls, Object value, Object[] params) throws ConversionException
	{
		...
		throw new ConversionException("The value '" + value + "' (" + value.getClass() + ")" + " can't be converted to a "
				+ cls.getName() + " object");
	}
	...
	static Number toNumber(Object value, Class<?> targetClass) throws ConversionException
	{
		...
		} else
		{
			...
			} catch (Exception ex)
			{
				...
				throw new ConversionException("Conversion error when trying to convert " + str + " to " + targetClass.getName(),
						ex);
			}
		}
	}
