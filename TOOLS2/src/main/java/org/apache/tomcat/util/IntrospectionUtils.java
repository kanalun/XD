...
public final class IntrospectionUtils
{
	...
	public static boolean setProperty(Object o, String name, String value, boolean invokeSetProperty)
	{
		...
		} catch (InvocationTargetException ie)
		{
			...
			if (log.isDebugEnabled())
				log.debug("IntrospectionUtils: InvocationTargetException for " + o.getClass() + " " + name + "=" + value + ")",
						ie);
		}
		return false;
	}
	...
	public static void setProperty(Object o, String name)
	{
		...
		{
			if (log.isDebugEnabled())
				log.debug("IntrospectionUtils: Exception for " + o.getClass() + " " + name, ex1);
		}
	}
	 ...
	 *            The jar list
	 * @param cp
	 *            a String classpath of directory or jar file elements separated
	 *            by path.separator delimiters.
	 * @throws IOException
			...
			throws Exception
	{
		...
		{
			if (log.isDebugEnabled())
				log.debug("IntrospectionUtils: Assert: Illegal params " + target + " " + param1);
		}
		if (log.isDebugEnabled())
			log.debug("IntrospectionUtils: callMethod1 " + target.getClass().getName() + " " + param1.getClass().getName() + " "
					+ typeParam1);
	...
	public static Object callMethod0(Object target, String methodN) throws Exception
	{
		...
		{
			if (log.isDebugEnabled())
				log.debug("IntrospectionUtils: Assert: Illegal params " + target);
			return null;
		}
		if (log.isDebugEnabled())
			log.debug("IntrospectionUtils: callMethod0 " + target.getClass().getName() + "." + methodN);
