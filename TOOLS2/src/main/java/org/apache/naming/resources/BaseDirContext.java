...
{
	private static final Logger log = LoggerFactory.getLogger(BaseDirContext.class);
	...
	public String getRealPath(String name)
	{
		...
		for (DirContext altDirContext : altDirContexts)
		{
			...
			{
				path = ((BaseDirContext) altDirContext).getRealPath("/META-INF/resources" + name);
				if (path != null)
					return path;
			}
		}
	 ...
	 * @exception NameNotFoundException
	 *                if an intermediate context does not exist
	 * @exception javax.naming.NotContextException
	...
	public final Attributes getAttributes(String name, String[] attrIds) throws NamingException
	{
		...
		{
			if (altDirContext instanceof BaseDirContext)
				attrs = ((BaseDirContext) altDirContext).doGetAttributes("/META-INF/resources" + name, attrIds);
			else
			{
				try
				{
	 ...
	 *            null
	 * @exception javax.naming.directory.AttributeModificationException
	 ...
	 */
	@Override
	public abstract NamingEnumeration<SearchResult> search(String name, Attributes matchingAttributes, String[] attributesToReturn)
			throws NamingException;
	 ...
	 *         filter; never null
	 * @exception javax.naming.directory.InvalidSearchFilterException
	 *                if the search filter specified is not supported or
	 *                understood by the underlying directory
	 * @exception javax.naming.directory.InvalidSearchControlsException
	 ...
	 */
	@Override
	public abstract NamingEnumeration<SearchResult> search(String name, String filter, SearchControls cons)
			throws NamingException;
	 ...
	 */
	@Override
	public abstract NamingEnumeration<SearchResult> search(String name, String filterExpr, Object[] filterArgs,
			SearchControls cons) throws NamingException;

	// ------------------------------------------------------ Protected Methods

	protected abstract Attributes doGetAttributes(String name, String[] attrIds) throws NamingException;
