...
public class FileDirContext extends BaseDirContext
{
	...
	{
		return org.apache.tomcat.util.http.RequestUtil.normalize(path, File.separatorChar == '\\');
	}

	/**
	 * Return a File object representing the specified normalized
	 * context-relative path if it exists and is readable. Otherwise, return
	 * <code>null</code>.
	 * 
	 * @param name
	...
	protected List<NamingEntry> list(File file)
	{
		...
		{
			/*
			 * Some IO error occurred such as bad file permissions. Prevent a
			 * NPE with Arrays.sort(names)
			 */
