...
public class ResourceCache
{
	 ...
	 * Not found cache.
	 */
	protected HashMap<String, CacheEntry> notFoundCache = new HashMap<String, CacheEntry>();
	...
	/**
	 * Return the access count. Note: Update is not synced, so the number may
	 * not be completely accurate. TODO: Currently unused. Expose via JMX?
	 */
	...
	/**
	 * Return the maximum size of the cache in KB. TODO: Currently unused.
	 * Expose via JMX?
	 */
	...
	/**
	 * Return the current cache size in KB. TODO: Currently unused. Expose via
	 * JMX?
	 */
	...
	/**
	 * Return the number of cache hits. Note: Update is not synced, so the
	 * number may not be completely accurate. TODO: Currently unused. Expose via
	 * JMX?
	 */
