...
public final class RequestUtil
{
	 ...
	 *             {@link org.apache.tomcat.util.http.RequestUtil#normalize(String)}
	 *             as a replacement.
	 */
	@Deprecated
	 ...
	 * @deprecated Deprecated to resolve a circular package dependency and will
	 *             be removed in Tomcat 8.0.x. Use
	 *             {@link org.apache.tomcat.util.http.RequestUtil#normalize(String, boolean)}
	 *             as a replacement.
	 */
	@Deprecated
	 ...
	 * @param encoding
	 *            The encoding to use; encoding must not be null. If an
	 *            unsupported encoding is specified the parameters will not be
