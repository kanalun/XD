...
public class AllscoreNamingStrategy implements NamingStrategy
{
	...
	public static String[] testColNames = { "INNER_ORDERID", "ORDER_INFO_ID", "MERCHANTID", "TERMINALID", "TRANSACTION_NO",
			"TRANSACTION_DATE", "PAY_AMOUNT", "CURRENCY", "CARD_NO", "CARD_TYPE", "BANK", "BANK_NO", "SETTLEMENT_DATE",
			"BATCH_NO", "DESCRIPTION", "CREATE_DATE", "STATUS", "TRANSACTION_TYPE", "CONTACT_NAME", "PHONE", "REFUND_DATE",
			"RETURNABLE_AMT", "ORI_PAY_AMOUNT", "NOTICE_STATUS", "NEXT_NOTICE_TIME", "NOTICE_TIMES" };
}
