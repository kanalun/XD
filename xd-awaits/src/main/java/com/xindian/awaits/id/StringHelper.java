...
public final class StringHelper
{
	...
	public static String replace(String beforePlaceholder, String afterPlaceholder, String placeholder, String replacement,
	 ...
	 * 'org.hibernate' the name 'org.hibernate.util.StringHelper' would become
	 * 'util.StringHelper'.
	 * 
	 * @param name
